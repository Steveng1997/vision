...
import { ModelTherapist } from '../../../../core/models/therapist'
import { ModelService } from '../../../../core/models/service'
import { LiquidationManager } from '../../../../core/models/liquidationManager'
import { LiquidationTherapist } from '../../../../core/models/liquidationTherapist'
...
export class SettingComponent implements OnInit {
  ...
  async consultManager() {
    await this.serviceManager.getByCompany(this.company).subscribe(async (dataInCharge: any) => {
  ...
  async consultTherapists() {
    this.serviceTherapist.getByCompany(this.company).subscribe(async (datosTerapeuta: any) => {
